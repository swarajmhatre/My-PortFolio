    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <div>
            <Link to="experience" smooth duration={500} className="group text-white px-6 py-3 w-fit flex items-center rounded-md bg-gradient-to-br from-purple-400 to-purple-900">
              portfolio
